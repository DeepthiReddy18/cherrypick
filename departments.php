...
<?php flashMsg('DEPARTMENT'); ?>
   <div class="row mb-3">
        ...
        <div class="col-md-6">
            <a href="<?php echo URLROOT; ?>/users/adddepartment" class="btn btn-primary pull-right" title="Add new Department">
    ...
    <table id = "departments" class="table table-bordered table-striped table-fixed" style="width:100%">
...
<script>
    $(document).ready(function() {
        $('#departments').DataTable({
            ...
            "order": [[ 1, "asc" ]],
            "ajax":{
                "url":"<?php echo URLROOT; ?>/users/dept_status",
                "type":"POST"  
            },       
            'columns': [
                { data: 'deptid',width: '2px' },
                { data: 'department'}, 
                { data: 'entered_by'},                         
                { data: 'userenteredon'},
